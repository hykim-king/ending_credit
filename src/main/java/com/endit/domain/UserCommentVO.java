...
public class UserCommentVO extends DTO {
	...
	public String toString() {
		return "UserCommentVO [commentId=" + commentId + ", memberId=" + memberId + ", contentId=" + contentId
				...
				+ ", profileImgUrl=" + profileImgUrl + ", likeCnt=" + likeCnt + ", ratingScore=" + ratingScore
				+ ", blindReason=" + blindReason + ", targetType=" + targetType + ", targetTitle=" + targetTitle
				+ ", releaseYear=" + releaseYear + ", collectionAuthorNickname=" + collectionAuthorNickname
				+ ", likedByMember=" + likedByMember + ", toString()=" + super.toString() + "]";
	}
